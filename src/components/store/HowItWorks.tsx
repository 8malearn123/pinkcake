...
const STEPS = [
  { icon: Wand2, num: '٠١', title: 'اختر أو صمّم', desc: 'تصفّح مجموعتنا الجاهزة أو صمّم كيكتك الخاصة بالحجم والنكهة التي تحبّ.' },
  { icon: ChefHat, num: '٠٢', title: 'نحضّرها بحُبّ', desc: 'يبدأ خبّازونا بتحضيرها طازجةً يدوياً بأجود المكوّنات المنتقاة بعناية.' },
  { icon: Truck, num: '٠٣', title: 'توصيل في الموعد', desc: 'نوصلها إلى بابك بعنايةٍ تامّة وفي الوقت المحدّد تماماً كما تتمنّين.' },
];
  ...
  return (
    <section className="rounded-[2rem] bg-card border border-border/60 p-7 md:p-10 shadow-soft-lift">
      <div className="text-center max-w-xl mx-auto">
        ...
        <h2 className="font-display text-2xl sm:text-3xl md:text-4xl mt-1 leading-tight">من الفكرة إلى بابك في ٣ خطوات</h2>
      </div>
