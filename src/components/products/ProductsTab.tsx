...
/**
 * «المنتجات» — the catalogue itself. Lifted out of the page unchanged when the
 * page gained a second tab («الكومبوهات»); the only difference is that the
 * «إضافة منتج» button now sits in this tab's toolbar rather than the shared page
 * header, so each tab owns its own actions.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Button onClick={() => setIsFormOpen(true)} className="gap-2 sm:ms-auto">
