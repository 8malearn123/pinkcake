...
export const CUSTOM_ORDERS = [
  { id: 'co1', order_number: 'CUS-2001', customer_name: 'لمياء', customer_phone: '+966••••601', branch_name: 'فرع العليا', status: 'custom_pending_review', order_kind: 'custom', product_type: 'كيكة زفاف', occasion: 'زواج', number_of_people: 60, flavor: 'فانيليا بوربون', filling: 'كريمة الزبدة', sugar_level: 'وسط', design_description: 'ثلاث طوابق باللونين الأبيض والذهبي مع ورود سكرية وأوراق ذهب', writing_text: 'مبارك الزواج', reference_image_url: null, pickup_date: today, pickup_time: '18:00', notes: null, created_at: iso(120), estimated_price: null },
  { id: 'co2', order_number: 'CUS-2002', customer_name: 'خالد', customer_phone: '+966••••602', branch_name: 'فرع النخيل', status: 'sent_to_chef', order_kind: 'custom', product_type: 'كيكة عيد ميلاد', occasion: 'عيد ميلاد', number_of_people: 12, flavor: 'شوكولاتة بلجيكية', filling: 'نوتيلا', sugar_level: 'وسط', design_description: 'شخصية كرتونية ثلاثية الأبعاد للأطفال', writing_text: 'كل عام وأنت بخير', reference_image_url: null, pickup_date: today, pickup_time: '16:00', notes: 'بدون مكسرات', created_at: iso(300), estimated_price: null },
  { id: 'co3', order_number: 'EVT-3001', customer_name: 'فاطمة', customer_phone: '+966••••603', branch_name: 'فرع العليا', status: 'custom_pending_review', order_kind: 'event', product_type: 'ضيافة مناسبة', occasion: 'حفل زفاف', number_of_people: 150, flavor: null, filling: null, sugar_level: null, design_description: null, writing_text: null, reference_image_url: null, pickup_date: today, pickup_time: '20:00', notes: 'القاعة شمال الرياض — يُفضّل التجهيز قبل الموعد بساعة', created_at: iso(60), estimated_price: null, guest_count: 150, serve_styles: ['centerpiece_cake', 'assorted_mini'], station_type: 'live', servers_needed: true, servers_count: 3, service_hours: 4, event_date: today, fulfillment_mode: 'onsite_setup' },
];
