    ...
    >
      <div className="max-w-3xl space-y-8">
        <p className="text-muted-foreground leading-relaxed">
          في بينك كيك نولي خصوصيتك أهمية كبيرة. توضّح هذه السياسة أنواع البيانات التي نجمعها وكيفية
          استخدامها وحمايتها، إضافة إلى حقوقك المتعلقة بها. باستخدامك لموقعنا فإنك توافقين على
        ...
        <section>
          ...
          <ul className="list-disc ps-5 mt-3 space-y-1 text-muted-foreground leading-relaxed">
            ...
            <li>تفاصيل طلباتك وتفضيلاتك السابقة.</li>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            موافقتك على ذلك، ويمكنك إلغاء الاشتراك في أي وقت.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc ps-5 mt-3 space-y-1 text-muted-foreground leading-relaxed">
            <li>مزوّدي خدمات التوصيل لإيصال طلباتك إلى عنوانك.</li>
